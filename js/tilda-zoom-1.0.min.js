...
function t_showZoom() {
    $('.t-zoomable').click(function (e) {
      ...
      <div class="t-carousel__zoomer__slides">\
        ...
        var id = $(this).closest(".r").attr("id"), images = $("#" + id + "").find(".t-zoomable");
        ...
        var target_url = $(this).attr("data-img-zoom-url"), target_img = $(".t-carousel__zoomer__img[src=\"" + target_url + "\"]"), slideItem = $(".t-carousel__zoomer__item"), target = target_img.closest(slideItem);
        target.show(0);
