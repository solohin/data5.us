...
(function ($) {
    ...
    function SequenceController() {
        ...
        /* document.documentElement.clientHeight || window.innerHeight || screen.availHeight;*/
...
(function ($) {
     ...
     * Global object that implements the event model.
     Â Â Â Â Â  * The essence of it is that he is one and is global, it all podpisyvayutsya
     Â Â Â Â Â  * Amity and ask him the same way
     Â Â Â Â Â  * (Instead of each object was emitterom = /)
     Â Â Â Â Â  *constructor
     Â Â Â Â Â  *version 0.0.1
     */
    function Observer() {
        this.callbacks = {};
    }
